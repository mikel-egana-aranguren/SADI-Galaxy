...
java -Xmx2000M -Xms250M -jar galaxy-dist/tool-data/shared/jars/sadi_generic_client.jar http://sadiframework.org/examples/pdb2uniprot tests/pdb2uniprot-input-trimmed.rdf > tests/pdb2uniprot-output-trimmed.rdf
